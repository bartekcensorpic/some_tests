...
video_path = r"C:\Users\barte\Pictures\youtube1_Trim.mp4"
cv_video_name = 'video'
...
width = input_size#vid.get(cv2.CAP_PROP_FRAME_WIDTH)  # float
height = input_size #vid.get(cv2.CAP_PROP_FRAME_HEIGHT)  # float

out = cv2.VideoWriter('third_yt.mp4', cv2.VideoWriter_fourcc(*'MP4V'), fps, (int(width), int(height)))
detector = MTCNN()
max_idx = 3000
idx =0
while True:
